...
namespace sdds {
    ...
    public:
        ...
        // 
        std::istream& read(std::istream& i = std::cin); //reads date in YYYY/MM/DD from console
        std::ostream& write(std::ostream& o = std::cout)const; // prints formatted date
        ...
        long int operator-(Date n)const; // differnce btw two dates (in days)
        operator bool() const;// validity of dates
